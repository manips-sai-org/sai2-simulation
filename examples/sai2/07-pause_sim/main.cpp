...
int main() {
    ...
    while (graphics->isWindowOpen())
	{
		...
		if(loop_counter == 700)
		{
			...
			cout << "sim timestep was: " << sim->timestep() << " seconds" << endl;
		...
		if(loop_counter == 1500) {
			...
			cout << endl << "elapsed sim time: " << sim->time() << " seconds" << endl;
			cout << "number of loops: " << loop_counter << endl;
			cout << "resetting simulation and setting timestep to 50 ms" << endl << endl;
			sim->setTimestep(0.05);
		}
		if(loop_counter == 2000) {
			cout << "elapsed sim time: " << sim->time() << " seconds" << endl;
			cout << "number of loops: " << loop_counter << endl;
			cout << "sim timestep was: " << sim->timestep() << " seconds" << endl << endl;
		}
